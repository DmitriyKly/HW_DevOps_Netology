...
terraform {
  ...
  backend "s3" {
    ...
    bucket     = "my-backet01" #FIO-netology-tfstate
  ...
  endpoints ={
    dynamodb = "https://docapi.serverless.yandexcloud.net/ru-central1/b1glp8u6n3mv8tv9fm8t/etnhn1ubroko28197n1f"
    s3 = "https://storage.yandexcloud.net"

  }

    dynamodb_table              = "mytable01"
  }
